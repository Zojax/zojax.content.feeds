...
$Id$
"""
import os, unittest, doctest, transaction
...
zojaxContentFeedsLayer = functional.ZCMLLayer(
    os.path.join(os.path.split(__file__)[0], 'ftesting.zcml'),
    __name__, 'zojaxContentFeedsLayer', allow_teardown=True)


def FunctionalDocFileSuite(*paths, **kw):
    layer = zojaxContentFeedsLayer
